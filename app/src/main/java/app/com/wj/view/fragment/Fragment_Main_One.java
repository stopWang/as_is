...
import app.com.wj.item_one.Fragment_Qu;

/**
 * Created by Administrator on 2016/3/25.
 * 首页的第一个fragment
 */
public class Fragment_Main_One extends Fragment implements ViewPager.OnPageChangeListener,View.OnClickListener{
    private View v;
    ...
    private Closemenu closeleftmenu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.main_one,container,false);
        return v;
    }
    ...
    private void iniView()
    {
        ...
        mFragments.add(new Fragment_Jueju());
        mFragments.add(new Fragment_Ci());
        mFragments.add(new Fragment_Qu());
        mFragments.add(new Fragment_Gufeng());
    ...
    public void onAttach(Activity activity){
        ...
        try{
            closeleftmenu=(Closemenu) activity;
